...
#define RIGHT_BUTTON_EXTI EXTI_Pin_0
#define LEFT_BUTTON_EXTI EXTI_Pin_3
 ...
 */
#define KEY_BUTTON_EXTI_IRQHANDLER (INTERRUPT_HANDLER(EXTI1_IRQHandler, 9))
#define RIGHT_BUTTON_EXTI_IRQHANDLER (INTERRUPT_HANDLER(EXTI0_IRQHandler, 8))
#define LEFT_BUTTON_EXTI_IRQHANDLER (INTERRUPT_HANDLER(EXTI3_IRQHandler, 11))
...
#define SEL_BUTTON_EXTI_IRQHANDLER (INTERRUPT_HANDLER(EXTI2_IRQHandler, 10))
...
#define EVAL_COM1_RxPin GPIO_Pin_3
#define EVAL_COM1_TxPin GPIO_Pin_2
