...
void SD_LowLevel_Init(void)
{
  ...
  GPIO_ExternalPullUpConfig(SD_SPI_SCK_GPIO_PORT, SD_SPI_MISO_PIN | SD_SPI_MOSI_PIN | SD_SPI_SCK_PIN, ENABLE);
...
void sFLASH_LowLevel_Init(void)
{
  ...
  /* Set the MOSI,MISO and SCK at high level */
  GPIO_ExternalPullUpConfig(sFLASH_SPI_SCK_GPIO_PORT, sFLASH_SPI_SCK_PIN | sFLASH_SPI_MISO_PIN | sFLASH_SPI_MOSI_PIN, ENABLE);
